    ...
    <div class="card-header border-0">
        <div class="row align-items-center">
            ...
            <div class="col text-right">
                <a href="{{ route('program.create') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus-square mr-2"></i>Buat Program</a>
            </div>
        </div>
    </div>
    <div class="table-responsive">
        ...
        <table class="table align-items-center table-flush">
            ...
            <tbody>
                @if ($programs->count() == 0)
                <tr>
                    <td colspan="5">Belum ada data program, <a href="{{ route('program.create') }}">buat sekarang</a>.</td>
                </tr>
                @else
