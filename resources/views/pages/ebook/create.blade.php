...
<div class="card">
    ...
    <div class="card-body">
        ...
        @endif
        <form action="{{ route('ebook.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="form-group">
                <label for="title" class="form-control-label">Judul Majalah</label>
                <input type="text" class="form-control" name="title" placeholder="Masukkan judul majalah" value="{{ old('title') }}">
            </div>
            <div class="form-group">
